...
class DemoView extends StyledComponent {
    ...
    compose() {
        return jdom`<main>
            ...
            <p>
                In this demo, we're animating the X and Y positions of the box to where you click within the grey box, using the dynamic animated values capabilities of the library.
